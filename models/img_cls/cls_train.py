#!/usr/bin/env python3
"""Leakage-free stage-1 weather classifier training for the ICRA protocol."""
...
def main():
    ...
    if train_sequences & val_sequences:
        raise RuntimeError(f"stage-1 train/val sequence overlap: {train_sequences & val_sequences}")
